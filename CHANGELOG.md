...
* [Config] Update config management to conform with https://github.com/EQEmu/Server/pull/3768

## [2.3.8]

* [Process Management] Fix to Windows 11 process management since the process list format is different

## [2.3.7]

* [Process Management] Launcher tweaks to fix loginserver, queryserv booting
