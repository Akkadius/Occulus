<template>
  <div class="dropdown">
    ...
    <a href="#" class="dropdown-toggle btn btn-primary lift" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      notifyProcessChange() {
        setTimeout(function () {
          ServerProcessEventBus.$emit('process-change');
        }, 1000);
