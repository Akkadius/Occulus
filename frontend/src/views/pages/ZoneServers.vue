<template>
  <div class="col-12">
    ...
    <div :class="['card', 'mb-3']" v-for="zone in zoneList">
        ...
        <div class="row align-items-center">
          ...
          <div class="col ml-n1" >
            <h4 class="mb-1">
              ...
              <router-link :to="'/deployment/'" style="color:#2364d2;font-weight:200;font-size: 18px;" v-if="zone.zone_long_name">
              ...
              <div class="mt-2" v-if="zone.zone_long_name">
                ...
                <a class="avatar-xs" data-toggle="tooltip" title="" data-original-title="Created by">
                  <img src="~@/assets/img/eqemu-avatar.png" style="height:20px;width:20px; border: 1px solid #666;" class="avatar-img rounded-circle ml-2">
                </a>
          ...
          <div class="col-auto">
            <p class="card-text small text-muted mb-1 mt-2" v-if="processStats[zone.zone_os_pid]">
              <i class="fe fe-clock"></i> {{ parseFloat(processStats[zone.zone_os_pid].elapsed / 1000 / 60 / 60).toFixed(2) }}h
            </p>
          </div>
