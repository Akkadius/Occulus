        ...
        <b-tabs content-class="mt-5" fill>
          ...
          <b-tab title="Key">
            <div class="form-group">
              ...
              <small class="form-text text-muted mt-3">Used in inter-server communication and allows remote zoneservers
                to connect back
              </small>
            </div>
          </b-tab>
          ...
          <b-tab title="Telnet / Websockets">
            ...
            <label class="pb-2 pt-2">
              ...
              <div class="custom-control custom-checkbox checklist-control">
                ...
                Telnet / Websockets Enabled <small class="ml-2 text-muted">(Keep this on or admin panel functionality
                will break)</small>
              </div>
